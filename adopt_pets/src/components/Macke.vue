...
<div class="row">
      <nav class="breadcrumbs">
        ...
        >
        <router-link to="/zivotinje">
            {{this.reci["breadcrumbs"][1][props]}}
        </router-link>
        >
        <router-link to="/zivotinje/macke">
            {{this.reci["breadcrumbs"][2][props]}}
        </router-link>
      </nav>
        ...
        <div class="col-sm-2 bg-white">
            ...
            <div class="col-6 col-md-4 d-flex align-items-stretch" style="max-height:600px;">
                <div class="card hoverable-link-card w-80 h-80">
                    <img class="card-img-top" src="../assets/macke/ana.jpg">
                    <div class="card-body d-flex flex-column">
                        <h3 class="card-title">Ana</h3>
                        <p class="card-text">
                        Ana je najbolji ljubimac.
                        </p>
                        <router-link class="btn btn-success go-to-button mt-auto" to="/zivotinje/macke/ana">
                        Poseti
                        </router-link>
                    </div>
                </div>
            ...
            <div class="col-6 col-md-4 d-flex align-items-stretch" style="max-height:600px;">
                <div class="card hoverable-link-card w-80 h-80">
                    <img class="card-img-top" src="../assets/macke/bane.jpg">
                    <div class="card-body d-flex flex-column">
                        <h3 class="card-title">Bane</h3>
                        <p class="card-text">
                        Bane je najbolji ljubimac.
                        </p>
                        <router-link class="btn btn-success go-to-button mt-auto" to="/zivotinje/macke/bane">
                        Poseti
                        </router-link>
                    </div>
                </div>
            ...
            <div class="col-6 col-md-4 d-flex align-items-stretch" style="max-height:600px;">
                <div class="card hoverable-link-card w-80 h-80">
                    <img class="card-img-top" src="../assets/macke/caka.jpg">
                    <div class="card-body d-flex flex-column">
                        <h3 class="card-title">Caka</h3>
                        <p class="card-text">
                        Caka je najbolji ljubimac.
                        </p>
                        <router-link class="btn btn-success go-to-button mt-auto" to="/zivotinje/macke/caka">
                        Poseti
                        </router-link>
                    </div>
                </div>
...
export default {
    name: "Macke",
     data(){
        ...
        created(){
            this.reci = reci.find(rec=>rec.component == "Macke" )
        }
}
